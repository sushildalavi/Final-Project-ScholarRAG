...
| **Auth** | `backend/auth.py` | Google ID token verification endpoint for local/dev usage |
...
| Auth | Google ID token verification (lightweight) | Replace with your preferred OAuth2/OIDC provider in production |
